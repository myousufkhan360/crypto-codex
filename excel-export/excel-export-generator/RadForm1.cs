...
namespace ExcelExportTms
{
    public partial class RadForm1 : Telerik.WinControls.UI.RadForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            tblTable = dataOps.GetClaimPaidData(dtpFromDate.Value, dtpToDate.Value);
            ...
            if (tblTable != null)
            {
                string fileName = @"C:\OutputFiles\TmsMtrClaimPaid_" + DateTime.Now.ToString("yyyyMMddTHHmmss") +".xlsx";
