        ...
        success: function(data) {
            ...
            $('#ddlCertificateOpenPolicy').change(function() {
                ...
                $.get('http://207.180.200.121/mtrprodsetup/MtrOpenPolicy/GetOPolicyByTxnID?_Json={"TxnSysID":' + $ddlCertificateOpenPolicy + '}', function(data) {
                    //Getting Leader Policy No By Open Policy
                    $LeaderPolicyNo = data.LeaderPolicyNo;
                    document.getElementById("txtLeaderNo").setAttribute("value", $LeaderPolicyNo);
                    //Getting Leader End No By Open Policy
                    $LeaderEndNo = data.LeaderEndNo;
                    document.getElementById("txtLeaderEndNo").setAttribute("value", $LeaderEndNo);
                    ...
                    $('#ddlRatingFactor').change(function() {
                        ...
                        $.get('http://207.180.200.121/mtrprodsetup/ProductRatingFactorSetUp/GetRatingFactorRate/?_Json={"ProductCode":' + $ProductCode + ',"RatingFactor":' + $ddlRatingFactor + '}', function(data) {
                            $TxtRate = data.Rate,
                    ...
                    ddlTrackerCompanyUrl = 'http://207.180.200.121/mtrprodsetup/ProductTrackerSetup/GetTrackerByPCode/?_Json={"ProductCode":"' + $ProductCode + '"}';
                    var Mydata;
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#ddlTrackerCompany').change(function() {
                                ...
                                $.get('http://207.180.200.121/mtrprodsetup/ProductTrackerSetup/GetTrackerAmount/?_Json={"ProductCode":' + $ProductCode + ',"TrackerCode":' + $ddlTrackerCompany + '}', function(data) {
                    ...
                    ddlRiderUrl = 'http://207.180.200.121/mtrprodsetup/ProductRiderSetup/GetRiderByPCode/?_Json={"ProductCode":"' + $ProductCode + '"}';
                    var Mydata;
                    $.ajax({
                        url: ddlRiderUrl,
                        type: "GET",
                        ...
                        success: function(data) {
                            ...
                            $('#ddlRider').change(function() {
                                ...
                                $.get('http://207.180.200.121/mtrprodsetup/ProductRiderSetup/GetRiderAmount/?_Json={"ProductCode":' + $ProductCode + ',"RiderCode":' + $ddlRider + '}', function(data) {
                    ...
                    const DdlConditionUrl = 'http://207.180.200.121/mtrprodsetup/ProductConditionsSetUp/GetConditionsByPCode/?_Json={"ProductCode":"' + $ProductCode + '"}';
                    var Mydata;
                    $.ajax({
                        url: DdlConditionUrl,
                        type: "GET",
                    ...
                    const DdlWarrantyUrl = 'http://207.180.200.121/mtrprodsetup/ProductWarrantiesSetup/GetWarrantiesByPCode/?_Json={"ProductCode":"' + $ProductCode + '"}';
                    var Mydata;
                    $.ajax({
                        url: DdlWarrantyUrl,
                        type: "GET",
                    ...
                    const DdlRatingFactorUrl = 'http://207.180.200.121/mtrprodsetup/ProductRatingFactorSetUp/GetRatingFactorByPCode/?_Json={"ProductCode":"' + $ProductCode + '"}';
                    var Mydata;
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $RatingFactorHidden=$("#RatingFactorHidden").val();
                            if($RatingFactorHidden){
                                $('#ddlRatingFactor').val($RatingFactorHidden).trigger('change');
                                $("#RatingFactorHidden").val('');
                            }
                        },
                        error: function(xhr, status, error) {
                            alert(status);
            ...
            $OpenPolicyCodeHidden=$("#OpenPolicyCodeHidden").val();
            if($OpenPolicyCodeHidden){
                $('#ddlCertificateOpenPolicy').val($OpenPolicyCodeHidden).trigger('change');
                $("#OpenPolicyCodeHidden").val('');
            }
        },
        error: function(xhr, status, error) {
            alert(status);
...
$(document).ready(function() {
    ...
    var $TblVechicleInsurance;
    //Getting All Records For Vechicle Insurance
    $('#ddlCertificateOpenPolicy').change(function() {
        $('#TblVechicleInsurance').DataTable().clear().destroy();
        var $ddlCertificateOpenPolicyValueS = $("#ddlCertificateOpenPolicy").find('option:selected').val();
        ...
        $.ajax({
            url: 'http://207.180.200.121/mtrprodsetup/MtrVehicleDetails/GetMtrVehicleDetails/?_Json={"TxnSysID":' + $ddlCertificateOpenPolicyValueS + '}',
            type: 'get',
            dataType: "JSON",
    ...
    $("#BtnVehicleSave").on("click", function() {
        ...
        var $ddlCertificateProductCodeValue = $("#ddlCertificateOpenPolicy").find('option:selected').val();
        var $ddlCertificateProductCode = $("#ddlCertificateOpenPolicy").find('option:selected').text();

        var $ddlCertificatePolicyTypeCodeValue = $("#ddlCertificateOpenPolicy").find('option:selected').val();
        var $ddlCertificatePolicyTypeCode = $("#ddlCertificateOpenPolicy").find('option:selected').text();
        ...
        var $ddlAgencyCodeValue = $("#ddlAgencyCode").find('option:selected').val();
        ...
        var $txtContractMaturityDate = $('#txtContractMaturityDate').val();
        ...
        //Field Validation
        if (!$ddlCertificateClientCodeValue || $ddlCertificateClientCode == 'Choose Client') {
        ...
        if (!$ddlCertificateOpenPolicyValue || $ddlCertificateOpenPolicy == 'Choose Open Policy') {
            document.getElementById("test").innerHTML = "Please Select Open Policy";
            $('#ErrorModalValidate').modal('show');
            setTimeout(function() {
                $('#ErrorModalValidate').modal('hide')
            }, 2000);
        ...
        if (!$ddlAgencyCodeValue || $ddlAgencyCode == 'Choose Agent') {
            document.getElementById("test").innerHTML = "Please Select Ageny";
            $('#ErrorModalValidate').modal('show');
            setTimeout(function() {
                $('#ErrorModalValidate').modal('hide')
            }, 2000);
            $('#ddlAgencyCode').focus().val($('#ddlAgencyCode').val());
            return false;
        }
        ...
        if (!$ddlCertificateProductCodeValue || $ddlCertificateProductCode == 'Choose Product') {
            document.getElementById("test").innerHTML = "Please Select Product";
            $('#ErrorModalValidate').modal('show');
            setTimeout(function() {
                $('#ErrorModalValidate').modal('hide')
            }, 2000);
            $('#ddlCertificateProductCodeValue').focus().val($('#ddlCertificateProductCodeValue').val());
            return false;
        }
        if (!$ddlCertificatePolicyTypeCodeValue || $ddlCertificatePolicyTypeCode == 'Choose Policy Code') {
            ...
            $('#ddlCertificatePolicyTypeCode').focus().val($('#ddlCertificatePolicyTypeCode').val());
            return false;
        }
        ...
        if (!$ddlOpCerTypeCodeValue || $ddlOpCerTypeCodeValue == 'Choose Certificate Type') {
        ...
        if (!$txtContribution) {
            ...
            $.get("http://207.180.200.121/mtrprodsetup/MtrInsPolicy/AddInsPolicy?_Json=" + $BtnPolicyHeaderNew, function(data) {
                $InsPolicyTxnId = data.ParentTxnSysID;
                $CertString = data.CertString;
                ...
                if ($ValidTxn == true) {
                    ...
                    if ($("#VechicleInsuranceRowIndex").val() == "-1") {
                       ...
                       //For  Birth Date Format
                        ...
                        if($ddlTakafulType == 'Choose Takaful Type'){
                        ...
                        var $BtnInsuredCertificateNew = {
                            ...
                            ContractMatDate: $txtContractMaturityDate,
                            RatingFactor: $ddlRatingFactorValue,
                        };
                        var $BtnInsuredCertificateNew = JSON.stringify($BtnInsuredCertificateNew);
                        $.get("http://207.180.200.121/mtrprodsetup/MtrVehicleDetails/AddMtrVehicleDetails?_Json=" + $BtnInsuredCertificateNew, function(data) {
                            $ValidTxn = data.IsValidTxn;
                            if ($ValidTxn == true) {
                                var rowNodes = $TblVechicleInsurance.row.add([data.SerialNo, data.VehicleCode, data.VehicleName, data.VehicleModel, data.ColorCode, data.ColorName, data.VehicleType, data.VehicleTypeName, data.RegistrationNumber, data.EngineNumber, data.ChasisNumber, data.Mileage, data.Deductible, data.UpdatedValue, data.PreviousValue, data.ParticipantValue, data.Rate, data.Contribution, data.InsuranceTypeCode, data.InsuranceTypeName, data.Tenure, data.CertTypeCode, data.CertTypeName, data.CommisionRate, data.ContractMatDate, data.Remarks, data.ParticipantName, data.ParticipantAddress, data.EmailAddress, data.AreaCode, data.AreaName, data.CityCode, data.CityName, data.BirthDate, data.Gender, data.CNICNumber, data.MobileNumber, data.ResNumber, data.OfficeNumber, data.PODate, data.PONumber, data.TxnSysID, data.VEODCode,data.RatingFactor,data.ParentTxnSysID]).draw();
                                ...
                                $.ajax({
                                    url: 'http://207.180.200.121/mtrprodsetup/MtrVContribution/GetMtrVContribution?_Json=' + $CalculatedContributionApi,
                                    type: 'get',
                                    dataType: "JSON",
                                    success: function(response) {
                                        var len = response.length;
                                ...
                                $(document).ready(function() {
                                    ...
                                    $("#BtnCertificateConditionSave").on("click", function() {
                                        ...
                                        var txtTxnSysID = $InsPolicyTxnId;
                                ...
                                $(document).ready(function() {
                                    ...
                                    $("#BtnTrackerProductSave").on("click", function() {
                                        ...
                                        if (!$ddlTrackerAmount) {
                                            document.getElementById("test").innerHTML = "Please Select Tracker aMOUNT";
                                            $('#ErrorModalValidate').modal('show');
                                            setTimeout(function() {
                                                $('#ErrorModalValidate').modal('hide')
                                            }, 2000);
                                ...
                                $(document).ready(function() {
                                    ...
                                    $("#BtnRiderProductSave").on("click", function() {
                                        ...
                                        if (!$ddlRiderAmount) {
                                            document.getElementById("test").innerHTML = "Please Select Rider Amount";
                                            $('#ErrorModalValidate').modal('show');
                                            setTimeout(function() {
                                                $('#ErrorModalValidate').modal('hide')
                                            }, 2000);
                        ...
                        $.get("http://207.180.200.121/mtrprodsetup/MtrVehicleDetails/UpdateMtrVehicleDetails?_Json=" + $BtnInsuredCertificateUpdate, function(data) {
                            ...
                            if ($ValidTxn == true) {
                                ...
                                array[24] = $txtContractMaturityDate;
                                array[25] = $txtRemarks;
                                array[26] = $txtParticipantName;
                                array[27] = $txtParticipantAddress;
                                array[28] = $txtEmail;
                                array[29] = $ddlAreaCode;
                                array[30] = $ddlAreaCodeValue;
                                array[31] = $ddlCityCodeValue;
                                array[32] = $ddlCityCode;
                                array[33] = $txtBirthDate;
                                array[34] = $ddlGenderValue;
                                array[35] = $txtCnicNum;
                                array[36] = $txtPersonalNum;
                                array[37] = $txtResidenceNum;
                                array[38] = $txtOfficeNum;
                                array[39] = $txtPoDate;
                                array[40] = $txtPoNumber;
                                array[41] = $txtCertificateTxnSysID;
                                array[42] = $ddlVEODCodeValue;
    ...
    $('#TblVechicleInsurance tbody').on('click', 'tr', function() {
        ...
        var $ContractMaturityDate = $selValue[24];
        ...
        $("#txtRemarks").val($selValue[25]);

        $("#txtParticipantName").val($selValue[26]);

        $("#txtParticipantAddress").val($selValue[27]);

        $("#txtEmail").val($selValue[28]);


        

        $ddlCityCode = $selValue[31];
        $('#ddlCityCode').val($ddlCityCode).trigger('change');

        $("#txtAreaCodeHidden").val($selValue[29]);

        var $BirthDateDate = $selValue[33];
        ...
        $ddlGender = $selValue[34];
        $('#ddlGender').val($ddlGender).trigger('change');

        $("#txtCnicNum").val($selValue[35]);

        $("#txtPersonalNum").val($selValue[36]);

        $("#txtResidenceNum").val($selValue[37]);


        //For  PO Date Format
        $("#txtOfficeNum").val($selValue[38]);
        var $PoDate = $selValue[39];
        ...
        $("#txtPoNumber").val($selValue[40]);

        $("#txtCertificateTxnSysID").val($selValue[41]);
        $UpdateCertificateTxnSysID = $selValue[41];
        $("#txtVechicleId").val($UpdateCertificateTxnSysID);
        $ddlVEODCode = $selValue[42];
        $('#ddlVEODCode').val($ddlVEODCode).trigger('change');

        $ddlRatingFactor = $selValue[43];
        $('#ddlRatingFactor').val($ddlRatingFactor).trigger('change');
        ...
        // Calling Tracker Values in table by Ajax
        $.ajax({
            url: 'http://207.180.200.121/mtrprodsetup/InsMtrTracker/GetInsMtrTracker?_Json={"ParentTxnSysID":' + $selValue[44] + "}",
            type: 'get',
            dataType: "JSON",
            success: function(response) {
                var len = response.length;
                for (var i = 0; i < len; i++) {
                    ...
                    var $ParentTxnSysID = response[i].ParentTxnSysID;
                    var $TxnSysID = response[i].TxnSysID;
                    $TblTableTrackerProductSetup.row.add([$TrackerCode, $TrackerName, $TrackerRate,$ParentTxnSysID ,$TxnSysID]).draw(false);
                }
            }
        });
        $("#BtnTrackerProductNew").on("click", function() {
            ...
            if (!$ddlTrackerAmount) {
                ...
                if ($("#TableTrackerProductRowIndex").val() == "-1") {
                    ...
                    $.get("http://207.180.200.121/mtrprodsetup/InsMtrTracker/AddInsTracker?_Json=" + $BtnTrackerProductNew, function(data) {
                        $ValidTxn = data.IsValidTxn;
                        if ($ValidTxn == true) {
                            var rowNodes = $TblTableTrackerProductSetup.row.add([data.TrackerCode, data.TrackerName, data.TrackerRate, data.ParentTxnSysID, data.TxnSysID]).draw();
                            $('#SubmitModal').modal('show');
                            setTimeout(function() {
                                $('#SubmitModal').modal('hide')
                            }, 2000);
        ...
        // Calling Rider Values in table by Ajax
        $.ajax({
            url: 'http://207.180.200.121/mtrprodsetup/InsMtrRider/GetInsMtrRider?_Json={"ParentTxnSysID":' + $selValue[44] + '}',
            type: 'get',
            dataType: "JSON",
            success: function(response) {
                var len = response.length;
                for (var i = 0; i < len; i++) {
                    ...
                    var $ParentTxnSysID = response[i].ParentTxnSysID;
                    var $TxnSysID = response[i].TxnSysID;
                    $TblTableRiderProductSetup.row.add([$RiderCode, $RiderName, $RiderRate, $ParentTxnSysID, $TxnSysID]).draw(false);
                }
            }
        });
        $("#BtnRiderProductNew").on("click", function() {
                ...
                if ($("#TableRiderProductRowIndex").val() == "-1") {
                    if($ddlRiderValue == 5 || $ddlRiderValue == 3){
                        ...
                        $.get("http://207.180.200.121/mtrprodsetup/InsMtrRider/AddInsRider?_Json=" + $BtnRiderProductNew, function(data) {
                            $ValidTxn = data.IsValidTxn;
                            if ($ValidTxn == true) {
                                var rowNodes = $TblTableRiderProductSetup.row.add([data.RiderCode, data.RiderName, data.RiderRate, data.ParentTxnSysID, data.TxnSysID]).draw();
                                $('#SubmitModal').modal('show');
                                setTimeout(function() {
                                    $('#SubmitModal').modal('hide')
                                }, 2000);
                    ...
                    var $BtnRiderProductNew = JSON.stringify($BtnRiderProductNew);
                    $.get("http://207.180.200.121/mtrprodsetup/InsMtrRider/UpdateInsRider?_Json=" + $BtnRiderProductNew, function(data) {
                        $ValidTxn = data.IsValidTxn;
                        if ($ValidTxn == true) {
        ...
        // Calling Condition Values in table by Ajax
        $.ajax({
            url: 'http://207.180.200.121/mtrprodsetup/InsMtrConditions/GetInsConditions?_Json={"ParentTxnSysID":' + $selValue[44] + '}',
            type: 'get',
            dataType: "JSON",
            success: function(response) {
                var len = response.length;
                for (var i = 0; i < len; i++) {
                    ...
                    var $Condition = response[i].Condition;
                    var $ParentTxnSysID = response[i].ParentTxnSysID
                    $TblTableConditionProductSetup.row.add([$ConditionShText, $TxnSysID, $Condition, $ParentTxnSysID]).draw(false);
                }
            }
        });
        // On Click Listener for New Empty Input Value and Focus On User Code
            ...
            if (!$ddlConditionValue) {
                ...
                if ($("#TableConditionProductRowIndex").val() == "-1") {
                    ...
                    $.get("http://207.180.200.121/mtrprodsetup/ProductConditionsSetUp/AddProductConditionsSetUp?_Json=" + $BtnConditionProductNew, function(data) {
                        ...
                        var $txtConditionTxnSysID = $('#txtConditionTxnSysID').val(data.TxnSysID);
                        if ($ValidTxn == true) {
                            var rowNodes = $TblTableConditionProductSetup.row.add([data.ConditionShText, data.TxnSysID, data.Condition, data.ParentTxnSysID]).draw();
                            $('#SubmitModal').modal('show');
                            setTimeout(function() {
                                $('#SubmitModal').modal('hide')
                            }, 2000);
        ...
        // Calling Warranty Values in table by Ajax
        $.ajax({
            url: 'http://207.180.200.121/mtrprodsetup/InsMtrWarranties/GetMtrWarranties?_Json={"ParentTxnSysID":' + $selValue[44] + '}',
            type: 'get',
            dataType: "JSON",
            success: function(response) {
                var len = response.length;
                for (var i = 0; i < len; i++) {
                    ...
                    var $TxnSysID = response[i].TxnSysID;
                    var $WarrantyShText = response[i].WarrantyShText;
                    $TblTableWarrantyProductSetup.row.add([$WarrantyShText, $ParentTxnSysID, $TxnSysID, $Warranty]).draw(false);
                }
            }
        });
            ...
            if (!$ddlWarrantyValue) {
                ...
                if ($("#TableWarrantyProductRowIndex").val() == "-1") {
                    ...
                    $.get("http://207.180.200.121/mtrprodsetup/ProductWarrantiesSetup/AddProductWarrantiesSetup?_Json=" + $BtnWarrantyProductNew, function(data) {
                        $ValidTxn = data.IsValidTxn;
                        if ($ValidTxn == true) {
                            var rowNodes = $TblTableWarrantyProductSetup.row.add([data.WarrantyShText, data.ParentTxnSysID, data.TxnSysID, data.Warranty]).draw();
                            $('#SubmitModal').modal('show');
                            setTimeout(function() {
                                $('#SubmitModal').modal('hide')
                            }, 2000);
        ...
        $.ajax({
            url: 'http://207.180.200.121/mtrprodsetup/MtrVContribution/GetAllMtrVContribution?_Json={"TxnSysID":' + $selValue[41] + '}',
            type: 'get',
            dataType: "JSON",
            success: function(response) {
                var len = response.length;
        ...
        $.ajax({
            url: 'http://207.180.200.121/mtrprodsetup/InsCoInsurance/GetAllInsCoInsurance?_Json={"TxnSysID":' + $selValue[41] + '}',
            type: 'get',
            dataType: "JSON",
            success: function(response) {
                var len = response.length;
    ...
    $("#BtnSearch").on("click", function() {
        ...
        if (!$txtSearchCertInfo) {
            ...
            $.ajax({
                url: "http://207.180.200.121/mtrprodsetup/MtrVehicleDetails/GetMtrVDByInfoForOPol/?_Json=" + $BtnCertSearchBy,
                type: 'get',
                dataType: "JSON",
                success: function(response) {
                    var len = response.length;
        ...
        $('#SearchTbl').off( 'click.rowClick' ).on('click.rowClick', 'tr', function () {
            ...
            $($row).addClass('ready');
            $('#ddlCertificateClientCode').val($SearchsellsValue[1]).trigger('change');
            $('#ddlCertificateOpenPolicy').val($SearchsellsValue[2]).trigger('change');
            $("#OpenPolicyCodeHidden").val($SearchsellsValue[2]);
            ...
            $("#RatingFactorHidden").val($SearchsellsValue[37]);
